...
const spotlightCards: SpotlightCard[] = [
	{
		...
		description:
			"Get a quick overview of your schedule, messages, and campus alerts before homeroom.",
	...
	},
	{
		...
		description:
			"See snapshots from the robotics lab, art studio, and community garden to find your fit.",
	...
	},
	{
		...
		description:
			"Preview where mentors host office hours and the cozy corners perfect for study sessions.",
			...
			<div className="container mx-auto grid items-center gap-12 px-4 lg:grid-cols-[1.1fr_0.9fr]">
				<div className="space-y-6">
					...
					<p className="text-lg text-muted-foreground">
						Tour the classrooms, hangout spots, and welcome events before you arrive.
						Each photo is a real moment captured by students who were new just like you.
					</p>
					<ul className="space-y-3 text-muted-foreground">
						<li className="flex gap-3">
							<span
								className="mt-1 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-secondary"
								aria-hidden="true"
							/>
							Follow curated galleries to learn where to grab lunch, join study
							groups, and meet mentors.
						</li>
						<li className="flex gap-3">
							<span
								...
								aria-hidden="true"
							/>
							Save favorite locations and bookmark events to build your personalized
							first-week plan.
						</li>
						<li className="flex gap-3">
							<span
								...
								aria-hidden="true"
							/>
							Share your own photos once you join and help next year's students feel
							at home faster.
						</li>
					</ul>
				</div>
