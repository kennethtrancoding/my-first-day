...
export default function MentorDirectory() {
	...
	const [filtered, setFiltered] = React.useState<Person[]>(mentors);
	const navigate = useNavigate();

	const lastConversationSelectedId = Number(useParams()["last-selected"]);
			...
			<div className="flex flex-col gap-6">
				<div className="flex items-center justify-between">
					...
					<div className="flex items-center gap-2">
						<Button
							variant="ghost"
							onClick={() => navigate(`/home/messages/${lastConversationSelectedId}`)}
							...
							<Card
								...
								<CardFooter className="mt-auto flex justify-start">
									<Button
										size="sm"
										onClick={() => {
											mentors.find((mentor) => mentor.id === m.id)
												.hasConnected === true;
											navigate(`/home/messages/${m.id}`);
										}}
